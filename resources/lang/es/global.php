...
return [
    ...
    'app is also available in your country' => ':appName is also available in your country: <a href=":url"><strong>:country</strong></a>. Starting good opportunities <a href=":url"><strong>here</strong></a> now!',
    'Login for faster access to the best deals' => '<a href=":login_url"><strong>Entrada</strong></a> para obtener un acceso más rápido a las mejores ofertas. <a href=":register_url"><strong>Haga clic aquí</strong></a> si usted no tiene una cuenta.',
    ...
    'Create your account, It is free' => 'Crea tu cuenta, es 100% gratis',
    'Gender' => 'Género',
    ...
    'File types' => 'Tipos de archivo: :file_types',
    'Browse' => 'Browse',
    'Add up to X pictures' => 'Añadir hasta :pictures_number fotos. Utilice una imagen real de sus productos.',
    ...
    'Your account details has updated successfully' => 'Your details account has updated successfully.',
    ...
    'Posting Ads is disabled' => 'Posting jobs was disabled for this time. Please try later. Thank you.',
    ...
    'This ad has expired' => '<strong>¡Atención!</strong> Este anuncio ha expirado. El producto o servicio no está más disponible (puede ser)',
