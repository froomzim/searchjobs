...
Route::group([
	...
	Route::group(['middleware' => ['web', 'install.checker']], function ($router) {
		...
		Route::group(['namespace' => 'Search'], function ($router) {
			...
			Route::get('{countryCode}/' . config('routes.companies'), 'CompanyController@index');
			...
			Route::get('{countryCode}/' . config('routes.companies') . '/{id}/' . config('routes.users.ads'), 'CompanyController@profile');
			...
			Route::get(config('routes.companies'), 'CompanyController@index');
			...
			Route::get(config('routes.companies') . '/{id}/' . config('routes.users.ads'), 'CompanyController@profile');
