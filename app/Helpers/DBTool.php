		...
		try {
			...
			if ($pdo instanceof \PDO) {
				...
				if (preg_match('/(MariaDB)+/i', $version)) {
					// NOTE: FUNCTION ST_Distance_Sphere does not exist in MariaDB
					// This function is supported in MySQL v5.7.6 or greater
					// So force DB version under 5.7.6 related to MySQL to use home made distance calculation function
					$version = '5.7';
				} else {
