...
class Page extends BaseModel
{
    ...
    */
    ...
    {
		$locale = isFromAdminPanel() ? config('appLang.abbr', 'en') : config('app.locale');
		
        return $this->belongsTo(Page::class, 'parent_id', 'translation_of')->where('translation_lang', $locale);
    }
